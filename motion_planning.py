...
from planning_utils import a_star, heuristic, create_grid, prune_path # I add prune_path
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        self.local_postion = global_to_local(self.global_position, self.global_home)
        ...
        self.global_goal = np.array([-122.398370, 37.793381, 0])  # [Longitude, Latitude, Altitude]
        self.local_goal = global_to_local(self.global_goal, self.global_home)
        grid_goal = (int(self.local_goal[0]) - north_offset, int(self.local_goal[1]) - east_offset)
